...
class ReasonForVisitViewController: BaseViewController {
    ...
    @IBOutlet var bookingHeaderViewHeightConstraint: NSLayoutConstraint!
    @IBOutlet var reasonForVisitTextView: UITextView!
...
public class KeyboardObservingConstraintModifier {
    ...
    public init(constraint: NSLayoutConstraint, inView view: UIView) {
        ...
        neutralConstant = constraint.constant
        self.view = view
...
public extension UIViewController {
    ...
    func addTapToDismissKeyboardGestureRecognizer(to view: UIView) {
    ...
    @objc func resignCurrentResponder(afterTapFrom _: UITapGestureRecognizer) {
