...
public class InputView: UIView, InputColorConfigurable {
    ...
    public lazy var validColor: UIColor = .init(named: namedValidColor) ?? UIColor.label
    ...
    public lazy var errorColor: UIColor = .init(named: namedErrorColor) ?? UIColor.systemRed
    ...
    public lazy var disabledColor: UIColor = .init(named: namedDisabledColor) ?? UIColor.systemGray3
