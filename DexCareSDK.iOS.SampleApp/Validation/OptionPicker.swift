...
public class OptionPicker: InputView {
    ...
    public let optionsPicker: UIPickerView = .init()
    lazy var pickerMapper: PickerMapper = .init(textField: textField, pickerView: optionsPicker)
    ...
    func setupUI() {
        ...
        let toolbar = UIToolbar(frame: CGRect(x: 0, y: 0, width: frame.width, height: Constants.toolbarHeight))
    ...
    @objc func voiceOverDidChange(note _: Notification) {
